...
*******************************************************************/
 ...
 #define StopI2C1()  SSP1CON2bits.PEN=1;while(SSP1CON2bits.PEN&&IIC_NOT_TIMOUT)
#else
...
*******************************************************************/
#ifdef SW_TIP_TIMEOUT
 #define StartI2C1()  SSP1CON2bits.SEN=1;while(SSP1CON2bits.SEN&&IIC_NOT_TIMOUT)
#else
...
*******************************************************************/
#ifdef SW_TIP_TIMEOUT
 #define RestartI2C1()  SSP1CON2bits.RSEN=1;while(SSP1CON2bits.RSEN&&IIC_NOT_TIMOUT)
#else
...
*******************************************************************/
#ifdef SW_TIP_TIMEOUT
 #define NotAckI2C1()     SSP1CON2bits.ACKDT=1, SSP1CON2bits.ACKEN=1;while(SSP1CON2bits.ACKEN&&IIC_NOT_TIMOUT)
#else
...
*******************************************************************/
#ifdef SW_TIP_TIMEOUT
 #define AckI2C1()        SSP1CON2bits.ACKDT=0, SSP1CON2bits.ACKEN=1;while(SSP1CON2bits.ACKEN&&IIC_NOT_TIMOUT)
#else
...
#ifdef SW_TIP_TIMEOUT
 #define IdleI2C1()    while (((SSP1CON2 & 0x1F) | (SSP1STATbits.R_W)) && IIC_NOT_TIMOUT)
#else
...
#if defined (I2C_V6_2)
#ifdef SW_TIP_TIMEOUT
 #define IdleI2C1()    while (((SSP1CON2 & 0x1F) | (SSP1STATbits.R_NOT_W)) && IIC_NOT_TIMOUT)
#else
...
***********************************************************************************************/
#ifdef SW_TIP_TIMEOUT
 #define IdleI2C2()    while (((SSP2CON2 & 0x1F) | (SSP2STATbits.R_NOT_W)) && IIC_NOT_TIMOUT)
#else
...
*******************************************************************/
#ifdef SW_TIP_TIMEOUT
 #define StopI2C()  SSPCON2bits.PEN=1;while(SSPCON2bits.PEN&&IIC_NOT_TIMOUT)
#else
...
*******************************************************************/
#ifdef SW_TIP_TIMEOUT
 #define StartI2C()  SSPCON2bits.SEN=1;while(SSPCON2bits.SEN&&IIC_NOT_TIMOUT)
#else
...
*******************************************************************/
#ifdef SW_TIP_TIMEOUT
 #define RestartI2C()  SSPCON2bits.RSEN=1;while(SSPCON2bits.RSEN&&IIC_NOT_TIMOUT)
#else
...
*******************************************************************/
#ifdef SW_TIP_TIMEOUT
 #define NotAckI2C()     SSPCON2bits.ACKDT=1;SSPCON2bits.ACKEN=1;while(SSPCON2bits.ACKEN&&IIC_NOT_TIMOUT)
#else
...
*******************************************************************/
#ifdef SW_TIP_TIMEOUT
 #define AckI2C()        SSPCON2bits.ACKDT=0;SSPCON2bits.ACKEN=1;while(SSPCON2bits.ACKEN&&IIC_NOT_TIMOUT)
#else
